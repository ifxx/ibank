...
<script type="text/javascript">
	...
	function get_action2() {
		...
		var answer2 = document.getElementById('toAccDropDownID2');
		...
		if (answer2[answer2.selectedIndex].value == "dropdown") {
			alert("Select To Account number");
			return false;
		} 
	...
	function doAjaxPost(fromacc, toacc, amt) {
		// get the form values  
...
<body>
	<div style="width: 97%; float: left; padding: 10px;">
		...
		<div
			...
			<table class="TFtable" >
			<tr><th width="20%" >To Account</th>
			<td>
			<select id="toAccDropDownID2" name="toAccNumberSelect2" >
			<option value="dropdown">--Select--</option>
			<s:iterator value="payeeDetails"> 
				<option value="<s:property value="payeeAccNo"/>"><s:property value="name"/>(<s:property value="payeeAccNo"/>)</option>
			</s:iterator>
			</select>
			</td>
			...
			<tr><th width="20%" >Transfer Amount</th>
